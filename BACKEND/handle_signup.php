...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($stmt->execute()) {
        ...
        header("Location: ../FRONTEND/PAGES/8password.html?success=" . urlencode('Signup successful, create your password.'));

    } else {
        header("Location: ../FRONTEND/PAGES/3signup.html?error=" . urlencode('Signup failed. Username or Email may be taken.'));
    }
    $stmt->close();
}